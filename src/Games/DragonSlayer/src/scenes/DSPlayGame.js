...
import { ImageBackground, Text, View, StyleSheet, Image, Animated, TouchableOpacity, Modal, BackHandler} from 'react-native';
...
export class DSPlayGame extends Component {
    ...
    startAnimation = () => {
        this.setState({ disabled: true, sword: require("../images/attackbuttonclicked.png") });
        const Animations =  require('./DSAnimation.js');
        Animations.diceAnim(this.state.dice1anim1,this.state.dice1anim2,this.state.dice2anim1,this.state.dice2anim2,this.state.dice3anim1,this.state.dice3anim2);
        ...
        // show score
        setTimeout(() => {
            this.setState({ score1: randomScore1, 
        ...
        setTimeout(() => {
            this.setState({ score2: randomScore2, 
        ...
        setTimeout(() => {
            this.setState({ score3: randomScore3, 
        ...
        // show explosion
        setTimeout(() => {
            this.setState({ showExplosion: require("../images/explosion.gif") }); }, 1200);
        setTimeout(() => {
            this.setState({ showExplosion: require("../images/explosion.gif") }); }, 4300);
        setTimeout(() => {
            this.setState({ showExplosion: require("../images/explosion.gif") }); }, 7300);
            ...
            <View style = {styles.container}>
                <Modal transparent = {true} visible = {this.state.scoreBoard}>
                    ...
                    <View style = {styles.modalBgContainer}>
                        <ImageBackground source = {require("../images/bgmodal.png")} style = {styles.modalBackgroundImage}>
                            <View style = {styles.modalInside}>
                                <View style = {styles.modalDices}>
                                    <View style = {styles.modalDiceSpace}>
                                        <Image source = {this.state.showDice1} style = {styles.modalDiceSize}/>
                                        <Image source = {this.state.showDice2} style = {styles.modalDiceSize}/>
                                        <Image source = {this.state.showDice3} style = {styles.modalDiceSize}/>
                                    </View>
                                    <View style = {styles.modalDiceTextSpace}>
                                        <View style = {styles.modalDiceTextSpaceEach}>
                                            <Text style = {styles.modalDiceText}>{this.state.score1}</Text>
                                        </View>
                                        <View style = {styles.modalDiceTextSpaceEach}>
                                            <Text style = {styles.modalDiceText}>{this.state.score2}</Text>
                                        </View>
                                        <View style = {styles.modalDiceTextSpaceEach}>
                                            <Text style = {styles.modalDiceText}>{this.state.score3}</Text>
                                        </View>
                                    </View>
                                </View>
                                <View style = {styles.modalScoreYS}>
                                    <Text style = {[styles.modalScoreText,styles.modalScoreText1]}>Your Score:</Text>
                                </View>
                                <View style = {styles.modalScoreNum}>
                                    <Text style = {[styles.modalScoreText,styles.modalScoreText2]}>{this.state.totalScore}</Text>
                                </View>
                                <View style = {styles.modalButtonSpace}>
                                    <View style = {styles.modalButtonSpace1}>
                                        <TouchableOpacity onPress = {this.playAgain}>
                                            <Image source = {require('../images/playagainbutton.png')} style = {styles.modalButton}/>
                                        </TouchableOpacity>
                                    </View>
                                    <View style = {styles.modalButtonSpace2}>
                                        <TouchableOpacity onPress={() => navigation.navigate('DSHome')}>
                                            <Image source = {require('../images/quitbutton.png')} style = {styles.modalButton}/>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
                ...
                <View style = {styles.firstHalfSpace} >
                    <View style = {styles.upperSpace}>
                        ...
                        <View style = {styles.scoreSpace}>
                            <Image source = {require('../images/coin.png')} style = {styles.coinIcon} />
                            <Text style = {styles.upperScoreText} >{this.state.totalCoins}</Text>
                        </View>
                    </View>
                    ...
                    <View style = {styles.dragonSpace}>
                        ...
                        <View style = {styles.diceSpace}>
                            <Animated.Image source={this.state.showDice3} style = {[styles.dice, animatedStyle3]} fadeDuration = {0} />
                        </View>
                        <View style = {styles.diceSpace}>
                            <Animated.Image source={this.state.showDice2} style = {[styles.dice, animatedStyle2]} fadeDuration = {0} />
                        </View>
                        <View style = {styles.diceSpace}>
                            <Animated.Image source={this.state.showDice1} style = {[styles.dice, animatedStyle1]} fadeDuration = {0} />
                        </View>

                        <View style = {styles.diceSpace}>
                            <Animated.Image source = {require('../images/dice_line.png')} style = {[styles.diceLine,diceLinePlace1]} />
                        </View>
                        <View style = {styles.diceSpace}>
                            <Animated.Image source = {require('../images/dice_line.png')} style = {[styles.diceLine,diceLinePlace2]} />
                        </View>
                        <View style = {styles.diceSpace}>
                            <Animated.Image source = {require('../images/dice_line.png')} style = {[styles.diceLine,diceLinePlace3]} />
                        </View>
                        
                        <Animated.Text style = {[styles.diceText,animatedStyle1]}>{this.state.score1}</Animated.Text>
                        <Animated.Text style = {[styles.diceText,animatedStyle2]}>{this.state.score2}</Animated.Text>
                        <Animated.Text style = {[styles.diceText,animatedStyle3]}>{this.state.score3}</Animated.Text>
                        <Image source = {this.state.showExplosion} style = {styles.explosion}></Image>
                        <View style = {styles.diceScore}>
                            <Text style = {styles.diceScoreText}/>
                            <Text style = {styles.diceScoreText}>{this.state.screenScore}</Text>
                        </View>
                    </View>
                </View>
                <View style = {styles.secondHalfSpace}>
                    ...
                    <View style = {styles.secondHalfSpace2}>
                        <TouchableOpacity disabled = {this.state.disabled} onPress = {this.startAnimation} activeOpacity={1}>
