...
class UFloadingScreen extends Component {
  ...
  componentDidMount() {
    ...
    Animated.parallel([
      ...
      setTimeout(() => navigation.navigate('MainScreen'), 5000);
    });
  }
  ...
  render() {
    ...
    return (
      <ImageBackground source={require("../PNG/k_bgLoading.png")} style={styles.backgroundImage}>
      <View style={styles.container}>
        <Animated.View
          ...
          <Image style={styles.dragonlogo} source={require("../PNG/horse-racing.gif")} />
        </Animated.View>
