    ...
    render(){
        ...
        if(this.state.moveCount1 >= finishLine){
            ...
            [
                ...
                {text: "Exit Game", onPress: ()=> {this.props.navigation.navigate('HomeScreen'); Orientation.lockToPortrait();}
                },
         ...
         else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine ){
         ...
         else if(this.state.moveCount1 >= finishLine && this.state.moveCount3 >= finishLine ){
         ...
         else if(this.state.moveCount1 >= finishLine && this.state.moveCount4 >= finishLine ){
         ...
         else if(this.state.moveCount1 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount3 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount4 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount3 >= finishLine && this.state.moveCount4 >= finishLine ){
        ...
        else if(this.state.moveCount3 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount4 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine && this.state.moveCount3 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine && this.state.moveCount4 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount3 >= finishLine && this.state.moveCount4 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount3 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount4 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount3 >= finishLine && this.state.moveCount4 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount3 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount3 >= finishLine && this.state.moveCount4 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount4 >= finishLine && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine && this.state.moveCount3 && this.state.moveCount4 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine && this.state.moveCount3 && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount2 >= finishLine && this.state.moveCount3 >= finishLine && this.state.moveCount4 && this.state.moveCount5 >= finishLine ){
        ...
        else if(this.state.moveCount3 >= finishLine && this.state.moveCount4 >= finishLine && this.state.moveCount5 && this.state.moveCount1 >= finishLine ){
        ...
        else if(this.state.moveCount4 >= finishLine && this.state.moveCount5 >= finishLine && this.state.moveCount2 && this.state.moveCount1 >= finishLine ){
        ...
        else if(this.state.moveCount1 >= finishLine && this.state.moveCount2 >= finishLine && this.state.moveCount3 && this.state.moveCount4 >= finishLine && this.state.moveCount5 >= finishLine ){
            ...
            return(
                    ...
                    <View style={styles.container}>
                        ...
                        <View style = {styles.horseSpace}>
                            ...
                            <Animated.View
                                style={moveAnimationStyle1}
                            >
                                {<Image source={require('../PNG/black.gif')} style={styles.imageStyle}></Image>}
                            </Animated.View>

                            <Animated.View
                                style={moveAnimationStyle2}
                            >
                                {<Image source={require('../PNG/Brown.gif')} style={styles.imageStyle}></Image>}
                            </Animated.View>

                            <Animated.View
                                style={moveAnimationStyle3}
                            >
                                {<Image source={require('../PNG/red.gif')} style={styles.imageStyle}></Image>}
                            </Animated.View>

                            <Animated.View
                                style={moveAnimationStyle4}
                            >
                                {<Image source={require('../PNG/white.gif')} style={styles.imageStyle}></Image>}
                            </Animated.View>
                        
                            <Animated.View
                                style={moveAnimationStyle5}
                            >
                                {<Image source={require('../PNG/yellow.gif')} style={styles.imageStyle}></Image>}
                            </Animated.View>
                        </View>
