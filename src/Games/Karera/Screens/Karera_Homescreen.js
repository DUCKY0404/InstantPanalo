...
class KR_Homescreen extends Component {
  componentDidMount() {
        ...
        <ImageBackground
          ...
          <View style={styles.menu}>
            ...
            <View style={styles.buttonspace3}>
              <TouchableOpacity
                onPress={() => navigation.navigate('KR_GameplayTransition')}>
                <Image
                  source={require('../PNG/k_play.png')}
                  style={styles.button}
                />
              </TouchableOpacity>
            </View>
            <View style={styles.buttonspace}>
              <TouchableOpacity
                onPress={() => navigation.navigate('KR_Tutorial')}>
                <Image
                  source={require('../PNG/k_how.png')}
