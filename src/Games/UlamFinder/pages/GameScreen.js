      ...
      return (
        ...
        <ImageBackground source={require("./images/bg5.jpg")} style={styles.backgroundImage}>
         ...
         <View style={styles.topRightScore}>
           <Image style={styles.coinImage} source={require('./images/coin1.gif')}></Image>
              ...
              <View style = {styles.modalContainer}>
                  ...
                  <View style = {{backgroundColor: "#660000", margin: 50,  padding:40, borderRadius:20, flex: 1}}>
                      <Text style={styles.topText}>{this.state.message} {totalPoints}</Text>
                        <Image style={{height: 120, width: 120, alignSelf: 'center'}} source={require("./images/coins.gif")}></Image>
