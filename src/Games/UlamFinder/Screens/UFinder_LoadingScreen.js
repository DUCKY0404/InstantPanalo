...
class UF_LoadingScreen extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    Animated.parallel([
      ...
      setTimeout(() => navigation.navigate('UF_HomeScreen'), 5000);
    });
  }
  ...
  render() {
    ...
    return (
      <ImageBackground
        source={require('../images/UF_BGLoading3-02.png')}
...
export default UF_LoadingScreen;
